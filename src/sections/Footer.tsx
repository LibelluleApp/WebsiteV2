...
export default function Footer() {
  return (
    <footer className="lg:py-24 w-full mx-auto py-20">
      <div className="md:gap-20 flex flex-col gap-12 max-w-9xl w-[90%] mx-auto">
        <div className="grid grid-col-1 md:grid-cols-3 gap-10 md:grid-rows-2 lg:grid-cols-5 lg:grid-rows-1">
          <div className="col-start-1 row-start-1 row-span-1 md:col-span-3 lg:col-span-2 lg:row-span-1 lg:col-start-1 flex flex-col gap-4">
            <div className="flex gap-2 items-center">
              <Image
                ...
                height={150}
              />
              <p className="text-grey text-xl font-bold font-ubuntu tracking-tight-custom">
                Libellule
              </p>
            </div>
            <div>
              ...
              <Link
                ...
                className="text-blue-800 font-semibold text-base underline"
              >
                support@libellule.app
              </Link>
            </div>
          </div>
          <div className="col-start-1 row-start-2 row-span-1 lg:col-span-1 lg:row-start-1 lg:col-start-3 flex flex-col gap-1">
            <p className="text-blue-900 text-lg font-bold font-host-grotesk">
              Nos réseaux sociaux
            </p>
            <div className="flex flex-col gap-1">
              <Link
                ...
                target="_blank"
                className="text-blue-800 font-normal text-base"
              >
                Instagram
              </Link>
              <Link
          ...
          <div className="col-start-1 md:col-start-2 row-start-3 md:row-start-2 row-span-1 lg:col-span-1 lg:row-start-1 lg:col-start-4 flex flex-col gap-1">
            <p className="text-blue-900 text-lg font-bold font-host-grotesk">
              Nos ressources
            </p>
            <div className="flex flex-col gap-1">
          ...
          <div className="col-start-1 md:col-start-3 row-start-4 md:row-start-2 row-span-1 lg:col-span-1 lg:row-start-1 lg:col-start-5 flex flex-col gap-1">
            <p className="text-blue-900 text-lg font-bold font-host-grotesk">
              À propos
            </p>
            <div className="flex flex-col gap-1">
              ...
              <Link href="/cgu" className="text-blue-800 font-normal text-base">
                CGU
              </Link>
            </div>
          </div>
        </div>
        <div className="s:items-center flex flex-col items-start gap-1">
